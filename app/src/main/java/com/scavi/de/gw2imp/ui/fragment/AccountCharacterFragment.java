...
import com.scavi.de.gw2imp.dagger2.component.DaggerAccountCharacterComponent;
...
public class AccountCharacterFragment extends AbstractFragment implements IAccountCharacterView {
    @Inject
    AccountCharacterPresenter mPresenter;
    ...
    protected void injectComponent(final ApplicationComponent applicationComponent) {
        AccountCharacterModule module = new AccountCharacterModule(this);
        DaggerAccountCharacterComponent.builder()
                .applicationComponent(applicationComponent)
                .accountCharacterModule(module)
                .build()
                .inject(this);
    }
